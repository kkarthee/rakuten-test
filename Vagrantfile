...
Vagrant.configure("2") do |config|
 ...
 # config.vm.box_url = "https://atlas.hashicorp.com/ubuntu/trusty64"
  ...
  config.vm.synced_folder "devops-challenge/" , "/webapps/devops/",
   owner: "appuser" , group: "www-data", mount_options: ["uid=555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555"]
